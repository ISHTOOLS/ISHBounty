...
class PaymentAccount(Base):
    ...
    iban_fingerprint: Mapped[str | None] = mapped_column(String(64), nullable=True)
    iban_masked: Mapped[str | None] = mapped_column(String(128), nullable=True)
    destination_type: Mapped[str] = mapped_column(String(16), default=PaymentDestinationType.IBAN.value)
    destination_fingerprint: Mapped[str] = mapped_column(String(64))
    destination_masked: Mapped[str] = mapped_column(String(128))
